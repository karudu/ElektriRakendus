Public Interface IGraafikInfo
    ...
    Function GetCustom(ByVal PakettID As Integer, ByVal PaketiTyyp As Integer, ByVal AlgAeg As Date, ByVal LoppAeg As Date, ByVal Flag As Integer) As List(Of (Aeg As String, Hind As Decimal))
