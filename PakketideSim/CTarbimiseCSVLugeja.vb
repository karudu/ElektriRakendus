...
Public Class CTarbimiseCSVLugeja
    ...
    Public Function LoeCSV(Lines As List(Of String), ofd As OpenFileDialog) As List(Of (Kuupäev As String, Voimsus_kWh As Decimal)) Implements ITarbimiseCSVLugeja.LoeCSV
