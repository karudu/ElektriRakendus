...
Public Class FormPakettideSim
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        table.Columns.Add("Kuupäev", GetType(String))
        table.Columns.Add("Tarbitud elekter (kWh)", GetType(Decimal))
        nupp = True
    ...
    Private Sub UuendaPaketid()
        ...
        If PakettID1 <> Nothing Then 'vormistab pakett 1 graafiku
            GInfo1 = GraafikConnect.GetCustom(PakettID1, cmbPkt1Tyyp.SelectedIndex, Algus, lopp, 0)
            ...
            lblPkt1Kesk.Text = GInfo1Kesk.ToString("N2") + " €/päev"
        End If


        If PakettID2 <> Nothing Then 'vormistab pakett 2 graafiku
            GInfo2 = GraafikConnect.GetCustom(PakettID2, cmbPkt2Tyyp.SelectedIndex, Algus, lopp, 0)
            ...
            lblPkt2Kesk.Text = GInfo2Kesk.ToString("N2") + " €/päev"
        End If
